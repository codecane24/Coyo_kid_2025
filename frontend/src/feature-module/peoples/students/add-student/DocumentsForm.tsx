// src/feature-module/peoples/students/add-student/DocumentsForm.tsx
            ...
            <div className="col-lg-6">
              <div className="mb-2">
                ...
                <div className="d-flex align-items-center flex-wrap">
                  ...
                  {isEdit && <p className="mb-2">AadharCard.pdf</p>}
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="mb-2">
                ...
                <div className="d-flex align-items-center flex-wrap">
                  ...
                  {isEdit && <p className="mb-2">TransferCertificate.pdf</p>}
                </div>
              </div>
            </div>
