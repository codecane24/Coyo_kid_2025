    ...
    <div className="card mt-4">
      <div className="card-header bg-light">
        <div className="d-flex align-items-center">
          ...
          <h5 className="mb-0 text-dark">Financial Details</h5>
        </div>
      </div>
      ...
      <div className="card-body">
        ...
        <div className="d-flex justify-content-between align-items-center mt-4">
          <div>
            <button type="button" className="btn btn-outline-danger me-2" onClick={() => removeEntry(entries.length - 1)} disabled={entries.length === 1}>
              <i className="bi bi-trash3 me-1" /> Delete Last
            </button>
            <button type="button" className="btn btn-outline-primary" onClick={addEntry}>
